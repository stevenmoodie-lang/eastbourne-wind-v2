    ...
    for d_date in df['date_only'].unique():
        ...
        if not day_block.empty:
            ...
            fig_bot.add_annotation(
                ...
                showarrow=False, yshift=15, xshift=15, font=dict(size=10, color="white"), row=2, col=1
            )
            ...
            fig_bot.add_annotation(
                ...
                showarrow=False, yshift=-15, xshift=15, font=dict(size=10, color="#d1d9e0"), row=2, col=1
            )
